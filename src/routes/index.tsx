  ...
  return (
    <div className="min-h-screen flex flex-col bg-background text-foreground overflow-x-hidden">
      ...
      <header className="sticky top-0 z-30 glass-panel">
        <div className="max-w-7xl mx-auto px-5 sm:px-8 lg:px-12 h-16 flex items-center justify-between gap-2">
          <Logo />
          <div className="flex items-center gap-1 sm:gap-2 shrink-0">
            ...
            <Button
              ...
              className="bg-primary text-primary-foreground h-9 px-3 text-sm sm:px-4"
            >
      ...
      <section className="relative overflow-hidden min-h-[80vh] sm:min-h-[92vh] flex flex-col items-center justify-center">
        ...
        <div className="hidden lg:block pointer-events-none absolute inset-0 -z-[5]">
          ...
          />
          <FloatingProfile
            className="right-[7%] top-[18%] float-soft-delayed"
            name="Lagos Bakery"
            role="Business"
            rating={4.8}
            white
          />
          <FloatingProfile
            className="left-[12%] bottom-[14%] float-soft-slow"
            name="Tunde B."
            role="Plumber"
            rating={5.0}
            gold
          />
          <FloatingProfile
            className="right-[10%] bottom-[18%] float-soft"
            name="Chidi M."
            role="Tutor"
            rating={4.7}
            blue
        ...
        <div className="relative max-w-7xl mx-auto px-6 sm:px-10 lg:px-12 py-16 sm:py-32 text-center">
          ...
          <div className="mt-8 flex flex-col sm:flex-row items-stretch sm:items-center justify-center gap-3 max-w-sm sm:max-w-none mx-auto">
            <Button
              size="lg"
              className="bg-primary text-primary-foreground h-12 px-8 rounded-full hover:scale-[1.03] transition-transform w-full sm:w-auto"
              onClick={goApp}
            >
              Get Started
            </Button>
        ...
        {/* Marquee ticker */}
        <div className="w-full border-y border-border/60 bg-background/40 backdrop-blur-md py-4 mt-auto">
          <div className="max-w-7xl mx-auto px-5 sm:px-8 lg:px-12 overflow-hidden">
      ...
      <section className="relative overflow-hidden border-b border-border/60">
        ...
        <div className="max-w-7xl mx-auto px-5 sm:px-8 lg:px-12 py-20 sm:py-24 grid gap-8 sm:grid-cols-3 text-center">
          {[
            ...
            <div
              key={s.label}
              className="rounded-2xl glass-card p-8 lift-hover hover:-translate-y-1"
            >
              <div className="text-5xl sm:text-6xl font-extrabold tracking-tight text-primary">
                {s.num}
              </div>
        ...
        <div className="max-w-7xl mx-auto px-5 sm:px-8 lg:px-12 py-24 sm:py-32">
          <div className="text-center max-w-2xl mx-auto mb-16">
            <h2 className="text-3xl sm:text-4xl font-bold">
              The <span className="text-primary">EasyMeet</span> difference
            </h2>
            <p className="text-muted-foreground mt-2">See how we're changing the game.</p>
          </div>
          <div className="grid gap-8 md:grid-cols-2">
            {/* BEFORE */}
            <div className="rounded-2xl border border-border/60 p-8 bg-card relative overflow-hidden">
              <div className="absolute top-0 right-0 text-[120px] font-extrabold text-muted/40 leading-none select-none">
                ✗
              </div>
              <span className="inline-block rounded-full bg-destructive/10 text-destructive text-xs font-semibold px-3 py-1 mb-4">
                Before
              </span>
              <ul className="space-y-4 relative z-10">
                {[
                  "Hours spent searching with no results",
                  "No way to verify who you're hiring",
                  "Unclear pricing and surprise charges",
                  "No protection if things go wrong",
                  "Trusting word-of-mouth blindly",
                ].map((item) => (
            ...
            {/* AFTER */}
            <div className="rounded-2xl border border-primary/30 p-8 bg-card relative overflow-hidden">
              <div className="absolute top-0 right-0 text-[120px] font-extrabold text-primary/10 leading-none select-none">
                ✓
              </div>
              ...
              <ul className="space-y-4 relative z-10">
                {[
                  "Find verified pros in under 5 minutes",
                  "Every profile is reviewed and trusted",
      ...
      <section>
        <div className="max-w-7xl mx-auto px-5 sm:px-8 lg:px-12 py-24 sm:py-32">
          <div className="text-center max-w-2xl mx-auto mb-12">
            <h2 className="text-3xl sm:text-4xl font-bold">
              Why <span className="text-primary">EasyMeet</span>
            </h2>
            <p className="text-muted-foreground mt-2">
              Everything you need to find and work with the right professional.
            </p>
          </div>
            ...
            {[
              {
                ...
                desc: "Every professional is reviewed and verified for your peace of mind.",
              },
              {
                Icon: CalendarCheck,
                title: "Easy Booking",
                desc: "Browse, compare, and book trusted services in just a few taps.",
              },
              {
                Icon: MessageCircle,
                title: "Secure Messaging",
                desc: "Chat privately with professionals before you commit.",
              },
            ].map(({ Icon, title, desc }) => (
              <div
                key={title}
                className="rounded-2xl glass-card p-6 lift-hover hover:-translate-y-1 hover:shadow-2xl hover:border-primary/50"
              >
          ...
          <div className="grid gap-6 md:grid-cols-3 relative">
            ...
            {[
              ...
              },
              {
                ...
                desc: "Search verified pros near you.",
              },
              {
                Icon: Handshake,
                n: "03",
                title: "Book & Connect",
                desc: "Message, book, and get it done.",
              },
            ].map(({ Icon, n, title, desc }) => (
              <div
                key={n}
                className="rounded-2xl glass-card p-6 relative lift-hover hover:-translate-y-1"
              >
                <div className="absolute -top-4 -right-2 text-6xl font-extrabold text-primary opacity-90 select-none">
                  {n}
                </div>
      ...
      <section>
        <div className="max-w-7xl mx-auto px-5 sm:px-8 lg:px-12 py-24 sm:py-32">
          <div className="text-center max-w-2xl mx-auto mb-12">
            <h2 className="text-3xl sm:text-4xl font-bold">
              Loved across <span className="text-primary">Nigeria</span>
            </h2>
            ...
            {[
              {
                name: "Chidinma A.",
                role: "Customer, Lagos",
                quote: "I found an amazing tailor in under 10 minutes. EasyMeet is the real deal.",
              },
              {
                name: "Tunde B.",
                role: "Professional, Abuja",
                quote: "Booking requests stream in every week — it transformed my business.",
              },
              {
                name: "Kemi's Salon",
                role: "Business, Ibadan",
                quote: "Verified profile gave us instant trust. Customers love it.",
              },
            ].map((t) => (
              <div
                key={t.name}
                className="rounded-2xl glass-card border border-border p-6 lift-hover hover:-translate-y-1"
              >
      ...
      <section className="border-y border-border/60 bg-muted/30">
        <div className="max-w-7xl mx-auto px-5 sm:px-8 lg:px-12 py-16 sm:py-20">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8 items-center justify-items-center opacity-60">
            {["Lagos State", "Abuja", "Port Harcourt", "Ibadan"].map((city) => (
              <div key={city} className="text-lg font-semibold text-muted-foreground">
                {city}
              </div>
            ))}
          </div>
      ...
      {/* WHY PROFESSIONALS LOVE EASYMEET */}
      <section>
        <div className="max-w-7xl mx-auto px-5 sm:px-8 lg:px-12 py-24 sm:py-32">
          <div className="text-center max-w-2xl mx-auto mb-12">
            <h2 className="text-3xl sm:text-4xl font-bold">
              Why professionals <span className="text-primary">love EasyMeet</span>
            </h2>
            <p className="text-muted-foreground mt-2">
            ...
            {[
              {
                ...
                desc: "Appear in search results when customers look for your services nearby.",
              },
              {
                title: "Build Trust",
                desc: "Verified profiles and reviews help you stand out from the competition.",
              },
              {
                title: "Manage Bookings",
                desc: "Accept, decline, and schedule appointments all from your dashboard.",
              },
              {
                title: "Secure Payments",
                desc: "Get paid safely through our escrow system with instant withdrawals.",
              },
              {
                title: "Grow Your Network",
                desc: "Connect with other professionals and expand your business reach.",
              },
              {
                title: "Analytics Dashboard",
                desc: "Track your performance, reviews, and earnings in real-time.",
              },
            ].map(({ title, desc }) => (
              <div
                key={title}
                className="rounded-2xl border border-border p-6 bg-card hover:border-primary/50 transition-colors"
              >
                <h3 className="font-semibold text-lg">{title}</h3>
                <p className="text-sm text-muted-foreground mt-1.5">{desc}</p>
              </div>
      ...
      <section className="max-w-7xl mx-auto px-5 sm:px-8 lg:px-12 pb-20 pt-16">
        <div className="rounded-3xl bg-primary p-10 sm:p-14 text-center text-primary-foreground relative overflow-hidden">
          ...
          <Button
            size="lg"
            variant="secondary"
            className="relative mt-6 h-12 px-8 rounded-full hover:scale-[1.03] transition-transform"
            onClick={goApp}
          >
            Get Started Free
          </Button>
    ...
    >
      ...
      <div className="min-w-0">
        <div className="flex items-center gap-1 text-sm font-semibold truncate">
          {name}
          {blue && (
            <span className="h-3.5 w-3.5 rounded-full bg-[#1d9bf0] inline-flex items-center justify-center text-[8px] text-white">
              ✓
            </span>
          )}
          {white && (
            <span className="h-3.5 w-3.5 rounded-full bg-white border border-slate-300 inline-flex items-center justify-center text-[8px] text-slate-700">
              ✓
            </span>
          )}
          {gold && (
            <span className="h-3.5 w-3.5 rounded-full gold-shimmer inline-flex items-center justify-center text-[8px] text-white">
              ★
            </span>
          )}
        </div>
